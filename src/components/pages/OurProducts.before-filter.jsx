...
const categorySections = [
  {
    name: 'Turmeric',
    products: products.filter((product) => product.category === 'Turmeric'),
  },
  {
    name: 'Red Chilli',
    products: products.filter((product) => product.category === 'Red Chilli'),
  },
  {
    name: 'Coconut',
    products: products.filter((product) => product.category === 'Coconut'),
  },
  {
    name: 'Hand Craft',
    products: products.filter((product) => product.category === 'Hand Craft'),
  },
  {
    name: 'Other Spices',
    products: products.filter((product) => product.category === 'Other Spices'),
  },
];
      ...
      <section className="our-products-intro">
        <div className="our-products-intro__inner">
          ...
          <p>
            ...
            food, handicraft and coconut-based products.
          </p>
      ...
      <section className="our-products-grid-section">
        ...
        {categorySections.map((category) => (
          ...
          >
            ...
            <div className="our-products-category-heading">
              <h2>{category.name}</h2>
            </div>
