...
const productItems = [
  ...
  { name: 'Dehydrated Onion', path: '/dehydrated-onion/' },  { name: 'Moringa Powder', path: '/moringa-powder/' },
  { name: 'Red Chilli', path: '/red-chilli/' },
  { name: 'Red Chilli Powder', path: '/red-chilli-powder/' }
];

const finalProductItems = [
  { name: 'Jute Gunny Bags', path: '/jute-gunny-bags/' },
  {
    name: 'Coconut Shell Charcoal Briquette',
    path: '/coconut-shell-charcoal-briquette/'
  }
];
